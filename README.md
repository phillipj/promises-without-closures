...
Its a very trivial example and of no real use. The interesting parts are [lib/TitleUpperCaser.js](./lib/TitleUpperCaser-prototype.js) with prototypes vs the closure version [lib/grabIt.js](lib/grabIt.js).